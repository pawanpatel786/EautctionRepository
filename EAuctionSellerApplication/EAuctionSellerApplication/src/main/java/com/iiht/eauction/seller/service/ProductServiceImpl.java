...
import com.iiht.eauction.seller.exception.BidDateExpiredException;
import com.iiht.eauction.seller.exception.BidNotFoundException;
import com.iiht.eauction.seller.exception.BidsExistInProductException;
import com.iiht.eauction.seller.exception.MoreThanOneBidByUserException;
import com.iiht.eauction.seller.exception.ProductNotFoundException;
...
import com.iiht.eauction.seller.repository.BidsRepository;
...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public boolean addBidToProduct(BidModel bidRequestModel) {
		...
		if (productOptional.isEmpty()) {
			...
			try {
				if (!Utility.isBidEndDateIsExpired(product.getBidEndDate())) {
					...
					BidModel savedBid = bidRepository.save(bidRequestModel);
