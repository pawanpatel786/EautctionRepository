...
public class ExceptionController {
	...
	public ResponseEntity<CustomResponse> customBadCredentialsException(BadCredentialsException exception) {

		CustomResponse expModel = new CustomResponse(HttpStatus.UNAUTHORIZED.value(),
